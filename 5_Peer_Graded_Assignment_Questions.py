...
Function that takes airline data as in put and create 5 dataframes based on the grouping condition to be used for plottling charts and grphs.
...
def get_graph(chart, year, children1, children2, c3, c4, c5):
    ...
    if chart == 'OPT1':
           ...
           # Percentage of diverted airport landings per reported airline
